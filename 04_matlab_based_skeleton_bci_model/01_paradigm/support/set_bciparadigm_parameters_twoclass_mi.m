...
[BCIpar.sfDisplay.class1_correct, ~, BCIpar.sfDisplay.class1_alpha_correct] = ...
    imread('pics/hand_squeezing_TRUE.png'); 
%%% Class 1 Start, wrong classified
[BCIpar.sfDisplay.class1_wrong, ~, BCIpar.sfDisplay.class1_alpha_false] = ...
...
[BCIpar.sfDisplay.class2_correct, ~ , BCIpar.sfDisplay.class2_alpha_correct] = ...
    imread('pics/foot_stretch_TRUE.png');
%%% Class 2, wrong classified
[BCIpar.sfDisplay.class2_wrong, ~ , BCIpar.sfDisplay.class2_alpha_false] = ...
    imread('pics/foot_stretch_FALSE.png');
%%% Bar plot
[BCIpar.sfDisplay.bar, ~ , BCIpar.sfDisplay.alpha_bar] = ...
    imread('pics/probability_bar.png');
...
BCIpar.sfDisplay.himage_class2_correct = image('CData', ...
    ...
    'Visible','off',...
    'AlphaData', BCIpar.sfDisplay.class2_alpha_correct, ...
    'XData',position_small, ...
    'YData',position_small);
%%% Class 2 Wrong
...
BCIpar.sfDisplay.himage_class2_wrong = image('CData', ...
    ...
    'Visible','off',...
    'AlphaData', BCIpar.sfDisplay.class2_alpha_false, ...
    'XData',position_small, ...
    'YData',position_small);
...
BCIpar.sfDisplay.himage_class1_correct = image('CData', ...
    ...
    'Visible','off',...
    'AlphaData', BCIpar.sfDisplay.class1_alpha_correct, ...
    'XData',position_small,...
    'YData',position_small);
...
BCIpar.sfDisplay.haxes_class1_wrong = axes(...
    ...
    'YDir', 'reverse', ...
    'Position', position_center);
BCIpar.sfDisplay.himage_class1_wrong = image('CData', ...
    BCIpar.sfDisplay.class1_wrong,...
    'Visible','off',...
    'AlphaData', BCIpar.sfDisplay.class1_alpha_false, ...
    'XData',position_small,...
    'YData',position_small);

BCIpar.sfDisplay.haxes_bar = axes(...
     'Color', 'none',...
     'Visible', 'off',...
     'YDir', 'reverse', ...
     'Position', position_up);
 
BCIpar.sfDisplay.himage_bar = image('CData', ...
     BCIpar.sfDisplay.bar,...
     'AlphaData', BCIpar.sfDisplay.alpha_bar,...
     'XData', position_small, ...
     'YData', position_small, ...
     'Visible','off');
