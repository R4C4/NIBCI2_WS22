...
BCIpar.sfDisplay.hfig = figure('Color', [0 0 0],...
...
% Include pictures:
BCIpar.sfDisplay.class1_start = imread('pics/hand_squeezing.png'); % upload the stimulus image 
...
BCIpar.sfDisplay.himage_class1_start = image('CData', BCIpar.sfDisplay.class1_start,...
    ...
    'XData',[-0.05 0.05],...
    'YData',[-0.05 0.05]);
BCIpar.sfDisplay.class2_start = imread('pics/foot_stretch.png'); % upload the stimulus image 
